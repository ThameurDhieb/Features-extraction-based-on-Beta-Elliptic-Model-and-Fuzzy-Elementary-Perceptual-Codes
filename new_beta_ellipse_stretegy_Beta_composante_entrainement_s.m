%function [matrice_param, nbr_trait,e,Vect_Erreurs] = new_beta_ellipse_stretegy_Beta_composante_entrainement(data_k, elimin_trait_excedent, rayon_filtre_V, sigma_p_filtre_V)
function [vecteur_param, matrice_param, param_trajectoire_BC, DAT_BC, indiceTemps_deb, points, nbr_trait, e, Vect_Erreurs_BC] = new_beta_ellipse_stretegy_Beta_composante_entrainement_s(data_k, elimin_trait_excedent, rayon_filtre_V, sigma_p_filtre_V)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [modele_sortie] = collecte_donnees_etendue(IMPULSION_BETA, ENTRAINEMENT, param_trajectoire_BC);
