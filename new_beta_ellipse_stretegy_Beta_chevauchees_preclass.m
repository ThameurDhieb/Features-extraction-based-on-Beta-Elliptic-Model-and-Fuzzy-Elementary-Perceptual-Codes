function [vecteur_param, matrice_param, param_trajectoire_BC, DAT_BC, indiceTemps_deb, points, nbr_trait, e, Vect_Erreurs_BC, famille_tg_horiz, KMH_deb_fin_traits] = new_beta_ellipse_stretegy_Beta_chevauchees_preclass(data_k, elimin_trait_excedent, rayon_filtre_V, sigma_p_filtre_V)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [modele_sortie, KMH_deb_fin_traits] = collecte_donnees_Beta_chevauchees_etendue_preclass(fonctions_beta, param_trajectoire_BC);
