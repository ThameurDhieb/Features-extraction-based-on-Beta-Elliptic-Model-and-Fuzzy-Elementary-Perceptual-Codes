...
function [mat_CPE_p_f] = ExtractCPEF2(x,grande_mmatrice_param_type2_entree_scripteurs_successifs)
xx=[];
...
ALLALL=[];
x=grande_mmatrice_param_type2_entree_scripteurs_successifs;
[n m] =size(x);
kk=0;
for ii=1:m
x=grande_mmatrice_param_type2_entree_scripteurs_successifs([1:12],:);
kk=kk+1;
All=[x(:,ii);mat_CPE_p_f(:,kk)];
x=grande_mmatrice_param_type2_entree_scripteurs_successifs([13:26],:);
kk=kk+1;
All2=[x(:,ii);mat_CPE_p_f(:,kk)];
x=grande_mmatrice_param_type2_entree_scripteurs_successifs([27:28],:);
