function [modele_sortie, KMH_deb_fin_traits] = collecte_donnees_etendue_preclass(IMPULSION_BETA, ENTRAINEMENT, param_trajectoire)
...
for  i = 1 : nbr_seg
     KMH_M1 = param_trajectoire(i,20);
     KMH_M2 = param_trajectoire(i,21);
     KMH_M3 = param_trajectoire(i,22);
     KMH_deb_trait_courant = min([KMH_M1 , KMH_M2 , KMH_M3]);
     KMH_fin_trait_courant = max([KMH_M1 , KMH_M2 , KMH_M3]);
